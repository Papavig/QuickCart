    ...
    <div class="container-fluid px-4 px-lg-5">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="ForwardServlet?destination=login">Login</a>
          </li>
        </ul>
      </div>
    </div>
      ...
      <div class="row border p-3 bg-white shadow">
        ...
        <div class="col-md-6">
          <div class="row align-items-center">
            <form class="row g-3" action="SignupServlet" method="post">
              <div class="col-md-6">
                <input
                        type="text"
                        class="form-control form-control-lg login-form"
              ...
              <div class="input-group mb-3">
                <button type="submit" class="btn btn-dark login-btn">Sign Up</button>
              </div>
              <div class="row">
                <p>Already have an account? <a href="ForwardServlet?destination=login">Login</a></p>
              </div>
            </form>
